...
{ :seq=>"18", :name=>"Produits forestiers Alliance Inc.", :cycle=>"1" },
...
{ :seq=>"60", :name=>"Bourse d'etudes Ruth-Hancock", :cycle=>"1,2,3" },
{ :seq=>"63", :name=>"Bourse commemorative Carol-Thomson", :cycle=>"1" },
{ :seq=>"73", :name=>"Bourse D'Alfred Bader", :cycle=>"1" },
{ :seq=>"74", :name=>"Lemaire Co-operative Studies Award", :cycle=>"1,2,3" },
...
{ :seq=>"183", :name=>"Minorities in Government Finance Scholarship", :cycle=>"1,2,3" },
...
{ :seq=>"199", :name=>"National Scholarship", :cycle=>"1" },
{ :seq=>"201", :name=>"The Wood Bursary", :cycle=>"1" },
...
{ :seq=>"367", :name=>"Jean-Berchmans-Fortin", :cycle=>"2,3" },
{ :seq=>"397", :name=>"Chaire RBC en innovations financieres - Bourses d'admission de deuxieme et troisieme cycles", :cycle=>"2,3" },
...
{ :seq=>"484", :name=>"Diabete Quebec - Bourses d'ete", :cycle=>"1,2,3" },
{ :seq=>"487", :name=>"Bourses de recherche de la Securite publique Canada en l'honneur de Stuart Nesbitt White", :cycle=>"2,3" },
